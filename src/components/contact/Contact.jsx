        ...
        <div className="contact" id="contact">
            ...
            <div className="contactForm">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="inputBox">
                        <textarea required="required" value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
                        <span>Type your Message...</span>
                    </div>
                    <div className="inputBox">
                        <input type="submit" name="" value="send" style={{background: loading ? "#ccc" : "rgb(34, 38, 241)" }}/>
                    </div>
                </form>
            </div>
            </div>
